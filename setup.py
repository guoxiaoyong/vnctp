...
ext_modules = [
    Extension(
        ...
        extra_link_arg=['-Lctplib', '-lthostmduserapi_se'],
        language='c++',
    ),
    Extension(
        'vnctp.vnctptd',
        ...
        extra_link_arg=['-Lctplib', '-lthosttraderapi_se'],
        language='c++'
    ),
]
...
class BuildExt(build_ext):
    ...
    if sys.platform == 'darwin':
        raise NotImplementedError('MacOS/Darwin not supported!')
...
setup(
    ...
    url='https://github.com/guoxiaoyong/vnctp',
